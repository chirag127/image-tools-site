---
type: index
title: "oriz-pixie-image-tools-app — knowledge bundle"
description: "App-specific knowledge for oriz-pixie-image-tools-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, pixie-image-tools]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-pixie-image-tools-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-pixie-image-tools-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: tools
- **Family role**: Free, browser-based image tools — compress, resize, crop, convert, watermark, upscale, BG-remove.
